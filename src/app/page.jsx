  ...
  return (
    <main className="">
      <Section id={"product"} showBlur={true} fillScreen={true}>
        <div className={"flex flex-col justify-between gap-20 h-full"}>
          ...
          >
            <h1
              className={
                "title text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium"
              }
            >
              Unlock the Web!
            </h1>
      ...
      {submitMessage && ( // Conditionally render the submission message
            ...
            <button
              className={
                "flex items-center gap-3 rounded-xl py-3 px-5 font-semibold text-sm text-white bg-violet-700 hover:bg-violet-800 transition-colors w-fit"
              }
            >
      ...
      <Section id={"features"} showBlur={true}>
        <div className={"flex flex-col gap-20"}>
          ...
          >
            <div
              className={
                "flex items-center gap-2 bg-[#6c28d93a] py-1 px-3 rounded-md text-white"
              }
            >
            ...
            <h1
              className={
                "title text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-medium w-full lg:w-[900px]"
              }
            >
              Harness the Power of AI for Smarter Data Collection
            </h1>
            <span className={"text-[#9a91a1] font-medium text-base sm:text-lg"}>
              Pecunie is here to get you the most relevant data in the form you
              want!
            </span>
            <button
              className={
          ...
          <div className={"flex flex-col gap-16 max-w-6xl mx-auto"}>
            <h5 className={"text-3xl font-medium text-center sm:text-left"}>
            ...
            >
              ...
              >
                <div
                  className={
                    "grid place-content-center text-[#4dffd4] border border-[#4dffd4] bg-[#4dffd52a] w-12 h-12 rounded-xl"
                  }
                >
              ...
              >
                <div
                  className={
                    "grid place-content-center text-[#1c92ff] border border-[#1c92ff] bg-[#1c92ff2a] w-12 h-12 rounded-xl"
                  }
                >
                ...
                <p className={"text-neutral-400 text-center sm:text-left"}>
                  Got a file or website you want structured data from? We got
                  you
                </p>
              </div>
              <div
              ...
              >
                <div
                  className={
                    "grid place-content-center text-[#854dff] border border-[#854dff] bg-[#854dff2a] w-12 h-12 rounded-xl"
                  }
                >
                ...
                <p className={"text-neutral-400 text-center sm:text-left"}>
                  Monitor data where required and push changes to your database
                  in realtime
                </p>
              </div>
              ...
              >
                ...
                <p className={"text-neutral-400 text-center sm:text-left"}>
                  Just give your instructions in text and watch the agent do
                  your work.
                </p>
              </div>
              <div
              ...
              >
                ...
                <p className={"text-neutral-400 text-center sm:text-left"}>
                  We don&apos;t save your credentials. Provide authentication
              ...
              >
                ...
                <p className={"text-neutral-400 text-center sm:text-left"}>
                  No backend functions or opaque API calls. Watch our agents in
                  action - right in your browser.
                </p>
              </div>
            </div>
          </div>
          <div
            className={
              "flex flex-col-reverse lg:flex-row items-center justify-between gap-10 px-5 sm:px-8 lg:px-14 py-5 sm:py-10 lg:py-20 border border-neutral-800 rounded-2xl lg:max-w-7xl w-fit lg:w-full mx-auto"
            }
          >
            <div className={"flex flex-col items-center lg:items-start gap-10"}>
              <span
                className={"text-xl sm:text-2xl md:text-3xl lg:text-4xl title"}
              >
                Generate Leads
              </span>
              <span
              ...
              <button
                className={
                  "flex items-center gap-3 border rounded-xl py-2 px-4 border-neutral-700 hover:border-neutral-600 transition-colors w-fit"
                }
              >
            ...
            <div>
              <div
                className={
                  "flex flex-col gap-10 border border-neutral-200 p-7 rounded-2xl w-[24rem]"
                }
              >
                ...
                <div className={"flex items-end justify-between"}>
                  ...
                  <div className={"flex flex-col items-end gap-2"}>
                    <div className={"flex items-center gap-2"}>
                      <span className={"text-xl font-medium text-violet-700"}>
                        +156.10%
                      </span>
                      <i className="fa-solid fa-arrow-up-right text-lg"></i>
                    </div>
                    <div
                      className={"h-3 w-[7rem] bg-neutral-200 rounded-full"}
                    ></div>
                  </div>
                </div>
              </div>
      ...
      <Section id={"faq"} showBlur={true}>
        <div
          className={"flex flex-col gap-20 max-w-4xl mx-auto relative"}
          style={{ zIndex: 3 }}
        >
          <div
            className={
          ...
          <div className={"flex flex-col gap-2"}>
            <FAQ
              ...
              description={
                "Pecunie is an AI-powered agent specifically designed for web data scraping at scale, helping businesses automate data collection from various online sources."
              }
            />
            <FAQ
              title={"What is Pecunie"}
  ...
  return (
    <div className="horizontal-scroll-container">
      ...
      <div className={"w-[1920px]"}>
        ...
        >
          <div
            className={"horizontal-scroll-item text-xl"}
...
function FAQ({ title, description }) {
  ...
  return (
    <motion.div
      ...
      className={`faq ${
        showDesc ? "show" : ""
      } flex flex-col gap-4 p-5 rounded-2xl cursor-pointer relative select-none`}
    >
